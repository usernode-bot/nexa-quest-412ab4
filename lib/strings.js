...
const STRINGS = {
  en: {
    ...
    'audio.mode.translation': 'Translation',
    'audio.mode.original': 'Original',
    'audio.mode.both': 'Both',
    'audio.hearingIn': 'Translated captions and voice are in {lang}.',
    'audio.speaking': 'speaking…',
    'audio.noTts': 'This browser cannot read text out loud, so translations appear as text only.',
    'audio.paused': 'Voice is off for now because some sentences could not be spoken. The text is still complete.',
    'audio.noSynth': 'This device has no speech synthesiser, so everything stays as text.',
    'audio.stopVoice': 'Stop the voice',
    'audio.busTitle': 'Audio bus',
    'audio.busBlurb': 'Diagnostic panel. It shows what is being spoken, how many clauses are queued, and whether the room is being ducked.',
    'audio.busNotReady': 'Audio bus not ready.',
    'audio.sample1': 'This is a sample of the translated voice. ',
    'audio.sample2': 'The second clause is spoken after it.',

    'sheet.aria': 'Language settings',
    'sheet.title': 'Your languages',
    'sheet.blurb': 'You speak one language and hear another. Everyone in the call picks their own pair.',
    'sheet.iSpeak': 'I speak',
    'sheet.iHear': 'I want to hear / read',
    'sheet.comingSoon': 'Coming soon',
    'sheet.save': 'Save languages',
    'sheet.saved': 'Languages saved',
    'sheet.uiLang': 'Interface language',
    'sheet.uiLangBlurb': 'The language of the buttons and labels in this app. It does not change what you hear.',
    'sheet.uiLangAuto': 'Match my device',

    'room.queued': 'You are number {n} in the queue. You will be able to speak when a slot opens.',
    'room.queuedShort': 'Number {n} in the queue.',
    'room.noStt': 'This browser has no speech recognition, so the microphone is off. Type your sentence and everything runs as usual: the original goes out, translations are still made, and other people still hear them read aloud.',
    'room.typePlaceholder': 'Type in {lang}',
    'room.orTypePlaceholder': '…or type it in {lang}',
    'room.startSpeaking': 'Start speaking',
    'room.stopSpeaking': 'Stop speaking',
    'room.ttsQuickTitle': 'Play translations out loud',
    'room.ttsOn': 'Translations are read out loud',
    'room.ttsOff': 'Translations are not read out loud',
    'room.hostLatency': 'Caption delivery: {med} ms median, {worst} ms worst, over the last {n} sentences.',
  ...
  id: {
    ...
    'audio.mode.translation': 'Terjemahan',
    'audio.mode.original': 'Asli',
    'audio.mode.both': 'Keduanya',
    'audio.hearingIn': 'Teks dan suara terjemahan dalam bahasa {lang}.',
    'audio.speaking': 'membacakan…',
    'audio.noTts': 'Peramban ini tidak bisa membacakan teks, jadi terjemahan tampil sebagai teks saja.',
    'audio.paused': 'Suara dimatikan sementara karena ada kalimat yang gagal dibacakan. Teksnya tetap lengkap.',
    'audio.noSynth': 'Perangkat ini tidak punya penyintesis suara, jadi semuanya tetap tampil sebagai teks.',
    'audio.stopVoice': 'Hentikan suara',
    'audio.busTitle': 'Audio bus',
    'audio.busBlurb': 'Panel diagnostik. Menunjukkan apa yang sedang dibacakan, berapa klausa yang mengantre, dan apakah suara ruangan sedang diredam.',
    'audio.busNotReady': 'Audio bus belum siap.',
    'audio.sample1': 'Ini contoh suara terjemahan. ',
    'audio.sample2': 'Klausa kedua dibacakan setelahnya.',

    'sheet.aria': 'Pengaturan bahasa',
    'sheet.title': 'Bahasa Anda',
    'sheet.blurb': 'Anda bicara dalam satu bahasa dan mendengar dalam bahasa lain. Setiap orang di panggilan memilih pasangannya sendiri.',
    'sheet.iSpeak': 'Saya bicara',
    'sheet.iHear': 'Saya ingin mendengar / membaca',
    'sheet.comingSoon': 'Segera hadir',
    'sheet.save': 'Simpan bahasa',
    'sheet.saved': 'Bahasa tersimpan',
    'sheet.uiLang': 'Bahasa antarmuka',
    'sheet.uiLangBlurb': 'Bahasa tombol dan label di aplikasi ini. Tidak mengubah apa yang Anda dengar.',
    'sheet.uiLangAuto': 'Ikuti perangkat saya',

    'room.queued': 'Anda nomor {n} dalam antrean. Anda bisa bicara begitu ada slot kosong.',
    'room.queuedShort': 'Nomor {n} dalam antrean.',
    'room.noStt': 'Peramban ini tidak punya pengenalan suara, jadi mikrofon dimatikan. Ketik kalimat Anda dan semuanya berjalan seperti biasa: teks asli terkirim, terjemahan tetap dibuat, dan peserta lain tetap mendengarnya dibacakan.',
    'room.typePlaceholder': 'Ketik dalam {lang}',
    'room.orTypePlaceholder': '…atau ketik dalam {lang}',
    'room.startSpeaking': 'Mulai bicara',
    'room.stopSpeaking': 'Berhenti bicara',
    'room.ttsQuickTitle': 'Bacakan terjemahan',
    'room.ttsOn': 'Terjemahan dibacakan',
    'room.ttsOff': 'Terjemahan tidak dibacakan',
    'room.hostLatency': 'Pengiriman teks: {med} ms tengah, {worst} ms terburuk, dari {n} kalimat terakhir.',
