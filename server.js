...
async function start() {
  ...
  if (IS_STAGING) {
    ...
    await pool.query(`
      ...
      VALUES
        ('Staging demo quest #1: Follow NexaQuest on X', 'Follow our social media account', false, 30),
        ('Staging demo quest #2: Join Discord', 'Join our community server', true, 50),
        ('Staging demo quest #3: Invite a friend', 'Invite someone to play', false, 20)
